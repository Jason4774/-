...
(function() {
    'use strict';
    var cracks=[
           {name:"默认线路",url:"http://player.jidiaose.com/supapi/iframe.php?v=%s",title:"默认线路"},
           {name:"备用线路",url:"http://shenjie.design/?url=%s",title:"备用线路"},
    ...
    if(!GM_getValue("hacgGodTurnVisited")){
        select.innerHTML+="<option value='http://www.cnblogs.com/shenjieblog/'>申杰博客</option>";
    }
    ...
    embedLabel.innerHTML="<input type='checkbox'>能嵌则嵌";
